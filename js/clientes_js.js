 ...
 //    }
	...
	$("#tbl td").on('click',function() {
		...
		$("#rut").val($(this).parent().children('td:eq(1)').text());
				$("#Cliente").val($(this).parent().children('td:eq(2)').text());
				$("#Empresa").val($(this).parent().children('td:eq(3)').text());
				$("#DomicilioEmpresa").val($(this).parent().children('td:eq(4)').text());
				$("#DomicilioDespacho").val($(this).parent().children('td:eq(5)').text());
				$("#Telefono").val($(this).parent().children('td:eq(6)').text());
				$("#Web").val($(this).parent().children('td:eq(7)').text());
				$("#EmailEmpresa").val($(this).parent().children('td:eq(8)').text());
				$("#Giro").val($(this).parent().children('td:eq(9)').text());
				$("#Contacto").val($(this).parent().children('td:eq(10)').text());
				$("#TelefonoContacto").val($(this).parent().children('td:eq(11)').text());
				$("#EmailContacto").val($(this).parent().children('td:eq(12)').text());
				$("#TwitterContacto").val($(this).parent().children('td:eq(13)').text());
				$("#IDPais").val($(this).parent().children('td:eq(14)').text());
				$("#IDRegion").val($(this).parent().children('td:eq(15)').text());
				$("#IDProvincia").val($(this).parent().children('td:eq(16)').text());
				$("#IDComuna").val($(this).parent().children('td:eq(17)').text());
				$("#IDCiudad").val($(this).parent().children('td:eq(18)').text());
				$("#IDFormaPago").val($(this).parent().children('td:eq(19)').text());
    ...
    if($(this).is(":checked")) {
        ...
        $("#rut").val($(this).parent().parent().parent().children('td:eq(1)').text());
				...
				$("#DomicilioEmpresa").val($(this).parent().parent().parent().children('td:eq(4)').text());
				$("#DomicilioDespacho").val($(this).parent().parent().parent().children('td:eq(5)').text());
				...
				$("#TwitterContacto").val($(this).parent().parent().parent().children('td:eq(13)').text());
				$("#IDPais").val($(this).parent().parent().parent().children('td:eq(14)').text());
				$("#IDRegion").val($(this).parent().parent().parent().children('td:eq(15)').text());
				$("#IDProvincia").val($(this).parent().parent().parent().children('td:eq(16)').text());
				$("#IDComuna").val($(this).parent().parent().parent().children('td:eq(17)').text());
				$("#IDCiudad").val($(this).parent().parent().parent().children('td:eq(18)').text());
				$("#IDFormaPago").val($(this).parent().parent().parent().children('td:eq(19)').text());
    } else {
        $(this).parent().parent().parent().removeClass("info");
		$("#tdo").prop("checked", false);
		$("#rut").val('');
