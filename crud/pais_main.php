	...
	<tr>
	  <td width="60%">
		...
		<tr>
		  ...
		  <td><input type="text" id="nombrepais" name="nombrepais" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
		</tr>
	      </tbody>
	    </table>
	  </td>
...
<div id="jt_pais" style="width: 100%;"></div>
...
<script type="text/javascript">
	...
	toolbar: {
	  items: [{
	    ...
	    click: function() {
	      ...
	      var $selectedRows = $('#jt_pais').jtable('selectedRows');
	...
	actions: {
	  listAction: 'pais_sql.php?action=list',
	  createAction: 'pais_sql.php?action=create',
	  updateAction: 'pais_sql.php?action=update',
	  deleteAction: 'pais_sql.php?action=delete'
	},
	fields: {
	  Id_pais: {
	    key: true,
	...
	buttons: {
	  ...
	  "Eliminar": function() {
	    var $selectedRows = $('#jt_pais').jtable('selectedRows');
	    $('#jt_pais').jtable('deleteRows', $selectedRows);
	    $(this).dialog("close");
	  }
	}
      });
