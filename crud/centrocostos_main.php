    ...
    <table width="65%" cellspacing="2" cellpadding="4">
		...
		<td width="60%">
			...
			<tbody><tr>
			    ...
			    <td><input type="text" id="centrocostos" name="centrocostos" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all "></td>
			</tr>
		    </tbody></table>
...
<div id="jt_centrocostos" style="width: 100%;"></div>
...
<script type="text/javascript">
	...
	//Prepare jTable
	    $('#jt_centrocostos').jtable({
		    jqueryuiTheme: true,
		    title: 'Listado',
		    paging: true,
		    pageSize: 10,
		    sorting: true,
		    defaultSorting: 'IDCentroCosto ASC',
		    ...
		    toolbar: {
			  items: [{
				  ...
				  click: function () {
				      ...
				      var $selectedRows = $('#jt_centrocostos').jtable('selectedRows');
		    ...
		    actions: {
			    listAction:	  'centrocostos_sql.php?action=list',
			    createAction: 'centrocostos_sql.php?action=create',
			    updateAction: 'centrocostos_sql.php?action=update',
			    deleteAction: 'centrocostos_sql.php?action=delete'
		    },
		    fields: {
			    IDCentroCosto: {
				    key: true,
	    ...
	    $('#jt_centrocostos').jtable('load');
	    
	    //buscar por clientes
	    $('#btnBUSCAR').on('click',function(e) {
		    e.preventDefault();
		    $('#jt_centrocostos').jtable('load', {
			nombreafp: $('#centrocostos').val(),
    ...
    //Initialize validation logic when a form is created
	  ...
	  $( "#dialog" ).dialog({
		  ...
		  buttons: {
		      ...
		      "Eliminar": function() {
			  var $selectedRows = $('#jt_centrocostos').jtable('selectedRows');
			  $('#jt_centrocostos').jtable('deleteRows', $selectedRows);
			  $( this ).dialog( "close" );
		      }
		  }
	  });
