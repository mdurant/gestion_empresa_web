...
<head>
<meta charset="utf-8">
<title>Maestro de Sistemas de Salud</title>
...
<h4>Maestro de Sistemas de Salud</h4>
	...
	<tr>
	  <td width="60%">
		...
		<tr>
		  ...
		  <td><input type="text" id="nombresalud" name="nombresalud" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
		</tr>
	      </tbody>
	    </table>
	  </td>
...
<div id="jt_salud" style="width: 100%;"></div>
...
<script type="text/javascript">
	...
	toolbar: {
	  items: [{
	    ...
	    click: function() {
	      ...
	      var $selectedRows = $('#jt_salud').jtable('selectedRows');
	...
	actions: {
	  listAction: 'salud_sql.php?action=list',
	  createAction: 'salud_sql.php?action=create',
	  updateAction: 'salud_sql.php?action=update',
	  deleteAction: 'salud_sql.php?action=delete'
	},
	fields: {
	  IDSalud: {
	    key: true,
	...
	formCreated: function(event, data) {
	  ...
	  $("form input[type=text], from textarea, form select").attr('class', 'form-control input-sm ui-corner-all');
      ...
      $('#jt_salud').jtable('load');

      //buscar por clientes
      $('#btnBUSCAR').on('click', function(e) {
	e.preventDefault();
	$('#jt_salud').jtable('load', {
	  nombresalud: $('#nombresalud').val(),
	...
	buttons: {
	  ...
	  "Eliminar": function() {
	    var $selectedRows = $('#jt_salud').jtable('selectedRows');
	    $('#jt_salud').jtable('deleteRows', $selectedRows);
	    $(this).dialog("close");
	  }
	}
      });
