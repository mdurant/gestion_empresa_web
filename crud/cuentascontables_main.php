	...
	<tr>
	  <td width="60%">
		...
		<tr>
		  ...
		  <td><input type="text" id="cuentascontables" name="cuentascontables" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
		</tr>
	      </tbody>
	    </table>
	  </td>
...
<div id="jt_cuentascontables" style="width: 100%;"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      //Prepare jTable
      $('#jt_cuentascontables').jtable({
	jqueryuiTheme: true,
	title: 'Listado',
	paging: true,
	pageSize: 10,
	sorting: true,
	defaultSorting: 'IDCuenta ASC',
	selecting: true,
	//Enable selecting
	multiselect: true,
	...
	toolbar: {
	  items: [{
	    ...
	    click: function() {
	      ...
	      var $selectedRows = $('#jt_cuentascontables').jtable('selectedRows');
	...
	actions: {
	  listAction: 'cuentascontables_sql.php?action=list',
	  createAction: 'cuentascontables_sql.php?action=create',
	  updateAction: 'cuentascontables_sql.php?action=update',
	  deleteAction: 'cuentascontables_sql.php?action=delete'
	},
	fields: {
	  IDCuenta: {
	    key: true,
	  ...
	  IDGrupoCuenta: {
	    ...
	    edit: true,
	    list: true,
	    options: 'cuentascontables_sql.php?action=grupocuentas'
	...
	formCreated: function(event, data) {
      ...
      $('#jt_cuentascontables').jtable('load');
	...
	buttons: {
	  ...
	  "Eliminar": function() {
	    var $selectedRows = $('#jt_cuentascontables').jtable('selectedRows');
	    $('#jt_cuentascontables').jtable('deleteRows', $selectedRows);
	    $(this).dialog("close");
	  }
	}
      });
