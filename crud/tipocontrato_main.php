	...
	<tr>
	  <td width="60%">
		...
		<tr>
		  ...
		  <td><input type="text" id="tipocontrato" name="tipocontrato" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
		</tr>
	      </tbody>
	    </table>
	  </td>
...
<div id="jt_tipocontrato" style="width: 100%;"></div>

        
<script type="text/javascript">
    $(document).ready(function() {
      //Prepare jTable
      $('#jt_tipocontrato').jtable({
	jqueryuiTheme: true,
	title: 'Listado',
	paging: true,
	pageSize: 10,
	sorting: true,
	defaultSorting: 'IDTipoContrato ASC',
	selecting: true,
	//Enable selecting
	multiselect: true,
	...
	toolbar: {
	  items: [{
	    ...
	    click: function() {
	      ...
	      var $selectedRows = $('#jt_tipocontrato').jtable('selectedRows');
	...
	actions: {
	  listAction: 'tipocontrato_sql.php?action=list',
	  createAction: 'tipocontrato_sql.php?action=create',
	  updateAction: 'tipocontrato_sql.php?action=update',
	  deleteAction: 'tipocontrato_sql.php?action=delete'
	},
	fields: {
	  IDTipoContrato: {
	    key: true,
	...
	buttons: {
	  ...
	  "Eliminar": function() {
	    var $selectedRows = $('#jt_tipocontrato').jtable('selectedRows');
	    $('#jt_tipocontrato').jtable('deleteRows', $selectedRows);
	    $(this).dialog("close");
	  }
	}
      });
