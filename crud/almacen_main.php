...
<head>
<meta charset="utf-8">
<title>Maestro de Almacen</title>
	...
	<tr>
	  <td width="60%">
		...
		<tr>
		  ...
		  <td><input type="text" id="nombrealmacen" name="nombrealmacen" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
		</tr>
	      </tbody>
	    </table>
	  </td>
...
<div id="jt_almacen" style="width: 100%;"></div>
...
<script type="text/javascript">
	...
	toolbar: {
	  items: [{
	    ...
	    click: function() {
	      ...
	      var $selectedRows = $('#jt_almacen').jtable('selectedRows');
	...
	actions: {
	  listAction: 'almacen_sql.php?action=list',
	  createAction: 'almacen_sql.php?action=create',
	  updateAction: 'almacen_sql.php?action=update',
	  deleteAction: 'almacen_sql.php?action=delete'
	},
	fields: {
	  IdAlmacen: {
	    key: true,
	...
	buttons: {
	  ...
	  "Eliminar": function() {
	    var $selectedRows = $('#jt_almacen').jtable('selectedRows');
	    $('#jt_almacen').jtable('deleteRows', $selectedRows);
	    $(this).dialog("close");
	  }
	}
      });
