	...
	<tr>
	  <td width="60%">
		...
		<tr>
		  ...
		  <td><input type="text" id="nombrecaja" name="nombrecaja" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
		</tr>
	      </tbody>
	    </table>
	  </td>
...
<div id="jt_cajas" style="width: 100%;"></div>
...
<script type="text/javascript">
	...
	toolbar: {
	  items: [{
	    ...
	    click: function() {
	      ...
	      var $selectedRows = $('#jt_cajas').jtable('selectedRows');
	...
	actions: {
	  listAction: 'cajascompensacion_sql.php?action=list',
	  createAction: 'cajascompensacion_sql.php?action=create',
	  updateAction: 'cajascompensacion_sql.php?action=update',
	  deleteAction: 'cajascompensacion_sql.php?action=delete'
	},
	fields: {
	  IDCaja: {
	    key: true,
	  ...
	  nombre_caja: {
	    title: 'Nombre Caja Compensaci\u00f3n',
	    width: '20%',
	    create: true,
	    edit: true,
	    list: true
	...
	formCreated: function(event, data) {
      ...
      $('#jt_cajas').jtable('load');

      //buscar por clientes
      $('#btnBUSCAR').on('click', function(e) {
	e.preventDefault();
	$('#jt_cajas').jtable('load', {
	  nombrecaja: $('#nombrecaja').val(),
	...
	buttons: {
	  ...
	  "Eliminar": function() {
	    var $selectedRows = $('#jt_cajas').jtable('selectedRows');
	    $('#jt_cajas').jtable('deleteRows', $selectedRows);
	    $(this).dialog("close");
	  }
	}
      });
