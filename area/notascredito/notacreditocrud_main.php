...
<div id="jt_nota_credito" style="width:100%;"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            var msg = {
              deleteConfirmation: 'Realmente desea Anular esta Nota de Crédito',
              deleteText: 'Anular'

            };
            //Prepare jTable
            $('#jt_nota_credito').jtable({
                    messages: msg,
                    jqueryuiTheme: true,
                    title: 'Gesti&oacute;n de Nota de Crédito',
                    paging: true,
                    pageSize: 10,
                    sorting: true,
                    openChildAsAccordion: true,
                    //Enable this line to show child tabes as accordion style
                    defaultSorting: 'IdEnotacredito ASC',
                    selecting: false,
                    //Enable selecting
                    multiselect: false,
                    ...
                    toolbar: {
                            items: [{
                              ...
                              text: 'Crear Nueva Nota de Crédito',
                              click: function() {
                    ...
                    actions: {
                        listAction:    'notacreditosql_sql.php?action=list',
                        deleteAction: 'notacreditosql_sql.php?action=delete'
                    },
                    fields: {
                            IdEnotacredito: {
                                key: true,
                            ...
                            Detalle: {
                              ...
                              $img.click(function () {
                                  ...
                                  $('#jt_nota_credito').jtable('openChildTable',
                                      $img.closest('tr'),
                                      {
                                            title: 'Detalle:',
                                            paging: true,
                                            ...
                                            defaultSorting: 'IdEnotacredito ASC',
                                            actions: {
                                                listAction: 'notacreditodet_sql.php?action=list&IdEnotacredito='+ datos.record.IdEnotacredito,
                                            },
                                            fields: {
                                                IdEnotacredito: {
                                                  type: 'hidden',
                                                  defaultValue: datos.record.IdEnotacredito
                                                },
                                                IdEnotacredito: {
                                                  key: true,
                                                  create: false,
                            ...
                            */
                            PDF: {
                                    ...
                                    display: function (datos) {
                                        ...
                                        $img.on("click", function() {
                                            ...
                                            window.location = "../../reportes/nota_credito.php?id_compra=" + datos.record.IdEnotacredito;
                            ...
                            Edicion: {
                                    ...
                                    display: function(datos) {
                                        //Create an image that will be used to open child table
                                        var $img = $('<center><button title="Modificar GD" class="btn btn-default btn-sm ui-corner-all" type="button" ><span class="glyphicon glyphicon-pencil"></span></button></center>');
                                        $img.on("click", function() {
            ...
            $(".jtable-main-container tr").find("td:eq(6)").each(function () {
                      ...
                      //$('#jt_nota_credito').jtable('load');
                        $('#jt_nota_credito').jtable('load', undefined, function(){
