...
public function obtiene_notacredito()
				{
				$nota_credito="";
				$query= "select * from enotacredito";
				$resul=mysql_query($query,Conectar::con());
				while($row=mysql_fetch_assoc($resul))
				{
					$nota_credito=$row["Numero"];
				}
				if(!$nota_credito)
				{
					$nota_credito="100000001";
				}
				else
				{
					$nota_credito= $nota_credito + 1;
				}
				return $nota_credito;
	...
	public function motivoguia()
{
	...
	public function almacen() // Se modifica query para apuntar s様o a la 0100/Central - Mauricio
	{
		$salida=array();
		$query="SELECT
	       almacen.IdAlmacen,
