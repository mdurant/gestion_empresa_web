...
$(function() {
 ...
 function calcular_total() {
      ...
      function valores() {
           ...
           valor2.val('').attr('value','');
           valor3.val('').attr('value','');
           valor4.val('');
           valor5.val('');
           valor6.val('');
      ...
      $(".btn-codigo").on('click', function() {
            ...
            valor2 =$tr.find('#cod_complete');
            valor3 =$tr.find('#descri');
            valor4 =$tr.find('#cantidades');
            valor5 =$tr.find('#valor');
            valor6 =$tr.find('#total_tbl');
            valor7 =$tr.find('#bod');
            valor8 =$tr.find('#desc');
