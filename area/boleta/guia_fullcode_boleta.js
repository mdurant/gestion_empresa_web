...
$(".cod").on('keyup',function(){
	...
	/*	var iva = parseFloat(total_direct)*0.19;
		...
		$(this).parent().parent().parent().children('td:eq(6)').children().children().prop('disabled',true);
		$("#pre-load").hide();
	}else
	{
		$("#tbl_foot tr td:eq(0)").children().html('<span  id="pre-load" style="display:none;">&nbsp;&nbsp;Procesando....&nbsp;&nbsp;<img src="../../img/loadingAnimation.gif"/></span>');
	...
	/*	var iva = parseFloat(total_direct)*0.19;
		...
		//$("#pre-load").hide();
				...
				estoy.parent().parent().parent().children('td:eq(6)').children().children().prop('disabled',false);
				$("#pre-load").hide();
				}
			}//succes
