...
if($_GET["IdEGuiaDespacho_General"])
{
...
}else
{
    ...
    $obtieneguia_generica=$guia->obtieneguia_generica();
...
<head>
<meta charset="utf-8">
<title>Guias de Despacho Genérica</title>
...
<body class="ui-widget">
    <div id="contenedor">
            <div id="tbl_pri">
            <center><h3>Guias de Despacho Genérica</h3></center>
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?>  disabled type="text" name="contador" style="width: 100%" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$obtieneguia_generica?>" tabindex="1" />
                </td>
