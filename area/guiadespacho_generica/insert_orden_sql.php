...
//$Empresa = $_SESSION['SESS_EMPRESA_ID'];
   ...
   $id_ultimo=$tra->insertar_eguia_general($contador,$folio,$factura,$proyecto,$cliente,$forma_pago,$neto,$iva,$impuesto,$total,$fecha_creacion,$fecha_guia,$user,$estado,$empresa,$motivo,$glosa,$estado_contable,$rut_chofer,$nombre_chofer,$patente,$autoriza);
	...
	//	$tra->insertar_dorden($id_ultimo[0],$posicion,$codigo,$descripcion,$cantidad,$bodega,$valor,$sub_total);
		$tra->insertar_dguia_general($id_ultimo[0],$posicion,$codigo,$descripcion,
						$cantidad,$decuento,$almacen,$sub_total,$iva_sub_total,
						$monto_impuesto,$tipo_impuesto,$total_gral,$empresa);
	...
	$vare="Guia Genérica ha quedado registrada!";
	$salida="todo";
