...
<head>
<meta charset="utf-8"/>
<title>Gestión de Guias de Despacho Genéricas</title>
...
<h4>Gestion de Guias de Despacho Genéricas</h4>
...
<div id="jt_guia_despacho_general" style="width: 100%;"></div>
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //Prepare jTable
            $('#jt_guia_despacho_general').jtable({
                jqueryuiTheme: true,
                title: 'Listado',
                paging: true,
                pageSize: 10,
                ...
                defaultSorting: 'IdEGuiaDespacho_General ASC',
                selecting: true,
                //Enable selecting
                multiselect: false,
                    ...
                    Detalle: {
                        ...
                        display: function(datos) {
                            ...
                            $img.click(function() {
                                ...
                                $('#jt_guia_despacho_general').jtable('openChildTable', $img.closest('tr'), {
                                    title: 'Detalle:',
                                    paging: true,
                                    pageSize: 10,
                                    sorting: false,
                    ...
                    */
                    ...
                    PDF: {
                        ...
                        $img.on("click", function()
                        {
                            ...
                            window.open("../../reportes/guia_despacho_generica.php?id_guia=" + datos.record.IdEGuiaDespacho_General);
                        });
                        return $img;
                        }
                    },
                    ...
                    //             window.location = "orden_main_edit.php?IdEGuiaDespacho_General=" + datos.record.IdEGuiaDespacho_General;
           ...
           $(".jtable-main-container tr").find("td:eq(5)").each(function () {
            ...
            $('#jt_guia_despacho_general').jtable('load');
                        ...
                        $.ajax({
                              ...
                              success: function(response) {
                                    alert("Se Guardo Correctamente");
                                      ...
                                      $("#fol").val("");
                                      $('#jt_guia_despacho_general').jtable('reload');
                              }
