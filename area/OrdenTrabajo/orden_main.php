...
<body class="ui-widget">
    <div id="contenedor">
            <div id="tbl_pri">
            <center><h3>Gestión de Proyectos</h3></center>
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:280px;" >
                        ...
                        <table>
                            <tr>
                                <td>
                                    <select name="clientes" id="clientes" style="width: 100%" class="span2"  value="">
            ...
            <tr>
                ...
                <td >
                <select name="sproyecto" id="sproyecto" style="width: 100%; max-width:40%;" class="span2"  value="">
                                    <option value="0">--Seleccionar--</option>
                                    <?php
                ...
                <td >
                <select name="sempresa" id="sempresa" style="width: 100%" class="span2"  value="">
                                    <option value="0">--Seleccionar--</option>
                                    <?php
