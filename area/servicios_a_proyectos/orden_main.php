        ...
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?> disabled type="text" name="contador" style="width: 180px;" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$contador?>" />
                </td>
                ...
                <td>
                  <table>
                        <tr>
                        <td >
                            <select name="proyecto" id="proyecto"   value="">
            ...
            <tr>
              ...
              <td >
                <select name="proveedor" id="proveedor" style="max-width: 90%" class="span2"  value="">
                  <option value="0">--Seleccionar--</option>
                    <?php
                    for($b=0;$b<sizeof($prove);$b++)
                      {
                    ?>
                  <option value="<?=$prove[$b]["IDsuppliers"]?>"><?=strtoupper($prove[$b]["Suppliers"])?></option>
                    <?php
                     }
                    ?>
              ...
              <td ><label>Nº Documento:</label></td>
                <td >
                  <input style="width: 180px;" class="form-control input-sm ui-corner-all"  type="text" name="txt_documento" id="txt_documento" value=""/>
                </td>
            </tr>
            <tr>
