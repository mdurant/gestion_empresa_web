        ...
        $(document).ready(function() {
            ...
            $('#jt_servicios_proyectos').jtable({
               ...
               title: 'Pago',
                ...
                //Create an image that will be used to open child table
                if(datos.record.estadocontable == "PAGADO")
                {
                                        
                    var $img = $('<center><button title="HOLA" class="btn btn-default btn-sm ui-corner-all" type="button" ><img src="../toolbar-icon/Rojo.png" style="cursor:pointer;" title="" /></button></center>');
                ...
                }else
                {
                    ...
                    var $img = $('<center><button title="HOLA" class="btn btn-default btn-sm ui-corner-all" type="button" ><img src="../toolbar-icon/Verde.jpg" style="cursor:pointer;" title="" /></button></center>');
