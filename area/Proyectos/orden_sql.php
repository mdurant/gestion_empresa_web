...
class cargar_orden
{
    ...
    public function insertar_eorden($contador,$folio,$id_cliente,$id_empresa,$fecha_ingreso,$f2,$jefe,$glosa,$patente,$vehiculo,$total,$iva,$total_gral)
    {
        $query=<<<QUERY
			INSERT INTO eorden(
			eorden.id_orden,
