...
<body class="ui-widget">
	<div id="contenedor">
    		<div id="tbl_pri">
            <center><h3>Orden Trabajo</h3></center>
	    <form name="form_tbl" id="form_tbl" action="" method="post">
			...
			<table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
			    <tr>
				<td style="width:110px">Contador</td>
				...
				<td style="width:100px;padding-left: 10px" align="left">Clientes</td>
				...
				<td style="padding-left: 10px"><?php if ($accion=='crear'){ ?>Buscar Plantilla<?php } ?></td>
				...
				<td  style="padding-left: 10px">Jefe Responsable</td>
				<td>
				    <input style="width: 100%" class="form-control input-sm ui-corner-all" type="text" name="jefe" id="jefe" value="<?=$ord[0]["jefe_responsable"]?>" />
				</td>
				<td align="center" >&nbsp;</td>
			<tr>
			    <td >Patente</td>
			    <td >
				<input style="width: 100%" class="form-control input-sm ui-corner-all" type="text" name="patente" id="patente" value="<?=$ord[0]["patente"]?>"/>
			    </td>
			    <td style="padding-left: 10px">Vehículo/Pieza</td>
			    <td>
