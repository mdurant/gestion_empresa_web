...
<body class="ui-widget">
	<div id="contenedor">
	    ...
	    <form name="form_tbl" id="form_tbl" action="" method="post">
			...
			<table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
			    <tr>
				<td style="width:110px">Voucher</td>
				<td style="width:150px;">
				    <input  type="text" name="contador" style="width: 100%" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$res?>" />
				</td>
	...
	<div class="divcabecera ui-widget-header ui-corner-all">
        <table style="text-align: center; width:100%" id="tbl_cab" class="table table-bordered table-condensed table-hover " cellspacing="2" >
        		...
        		<thead>
                        ...
                        <th width="81px;" style="display: none;"><center></center></th>
		...
		<fieldset>
		 ...
		 <input type="hidden" name="id_ord" id="id_ord" value="<?=$_GET["idasiento"];?>"/>
		</fieldset>
            	...
            	<tr>
					...
					<td width="113px;"><center>
						<table style="width: 100%">
							<TR>
								 <TD style="width: 100%"><input  style="border:none;width: 100%;"  type="text" name="codigo[]" id="cod_complete" value="<?=$ord2[$i-1]["Codigo"]?>" class="form-control input-sm caja_cod cod cod_complete"/></TD>
								 <TD >
        ...
        <div id="pie">
            ...
            <table border="0" class="table table-condensed table-bordered" cellspacing="2">
            	<tr>
                    ...
                    <td width="34%" align="right" style="text-align:right;">&nbsp;</td>
                </tr>
    ...
    <!--####################################################################################################################-->
		...
		<div class="ui-widget-content ui-corner-all" style="width: 100%; height: 45px">
  		...
  		<div id="jt_cuentas" style="width: 1200px;"></div>
		</div>
