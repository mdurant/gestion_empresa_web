        ...
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?>  disabled type="text" name="contador" style="width: 100%" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$contador?>" />
                </td>
  ...
  $("#folio").focusout(function(e){
         ...
         $("#resultado").delay(1000).queue(function(n) {      
              ...
              $("#resultado").html('<img src="../../img/loadingAnimation.gif" />');
                    ...
                    $.ajax({
                          type: "POST",
                          url: "comprueba_folio_guia_compra.php",
                          data: "b="+consulta,
                          dataType: "html",
                          error: function(){
