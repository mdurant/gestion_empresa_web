...
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({
            ...
            type:"POST",
            dataType:"json",
            url:"./select_guia_edit.php?action=traerDatos&id=<?=$_GET['ideguiacompra']?>",
            ...
            success: function(response){
                ...
                $("#proveedor").val(response[0].id_proveedor);            
                $("#orden_compra").val(response[0].orden_compra);
                $('#fecha_guia').datepicker( "option", "dateFormat", "yy-mm-dd");
                $("#fecha_guia").datepicker( "setDate", response[0].fecha_emision.substring(0,10).trim());
                $('#fecha_guia').datepicker( "option", "dateFormat", "dd-mm-yy");
                $("#numero_factura").val(response[0].factura_numero);  
                $("#empresa").val(response[0].id_empresa);
                $("#motivo").val(response[0].id_motivo);
        ...
        $.ajax({
            ...
            type:"POST",
            dataType:"json",
            url:"./select_guia_edit.php?action=traerDatos2&id=<?=$_GET['ideguiacompra']?>",
            ...
            success: function(response){
                ...
                for (var i = 0; i <=response.length; i++) {
                        ...
                        $("#posicion"+response[i].posicion).parent().parent().parent().find("#idepos").val(response[i].id_dguia_compra);
                        ...
                        $("#posicion"+response[i].posicion).parent().parent().parent().find('#valor').val(response[i].valor_compra);
                        $("#posicion"+response[i].posicion).parent().parent().parent().find('#total_tbl').val(response[i].neto_detalle);
          ...
          $("#modal1").dialog({
           ...
           $("#editarGuia").on("click", function(){
                ...
                $('.total').each(function () {
                   ...
                   var factura_numero   = $("#numero_factura").val();  
                   var Neto             = ValorNeto;
                   var Iva              = parseInt(ValorNeto * 0.19);
                   var Total            = parseInt(Neto) + parseInt(Iva);
                   var fecha_emision    = $('#fecha_guia').val();
               ...
               $.ajax({
                    ...
                    dataType            :"json",
                    data                : parametros,
                    url                 :"./select_guia_edit.php?action=editarDatos&id=<?=$_GET['ideguiacompra']?>",
                    beforeSend: function () {
                      ...
                      }else
                      {
                        ...
                        var parametros2 = {
                         ...
                         $.ajax({
                              ...
                              dataType            :"json",
                              data                : parametros2,
                              url                 :"./select_guia_edit.php?action=insertarDatos&id=<?=$_GET['ideguiacompra']?>",
                              beforeSend: function () {
        ...
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?> type="text" name="contador" style="width: 100%" class="form-control input-sm ui-corner-all"  id="contador" value="" />
                </td>
