        ...
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <div id="cuerpo">
                ...
                <tbody>
                    ...
                    <td width="81px;"><center><input style="border:none;width:100%;"  type="text" name="bodega[]" disabled id="bodega" value="<?=$res8[$i-1]["Almacen"]?>" class="form-control input-sm act"/></center></td>
