...
<head>
<meta charset="utf-8"/>
<title>Solicitudes hacia Bodega</title>
    <!-- bootstrap -->
...
<h4>Solicitudes hacia Bodega</h4>
...
<div id="jt_solicitud" style="width:100%;"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            var msg = {
              deleteConfirmation: 'Realmente desea Anular esta solicitud',
              deleteText: 'Anular Solicitud'
                    ...
                    fields: {
                            ...
                            Detalle: {
                              ...
                              $img.click(function () {
                                  ...
                                  $('#jt_solicitud').jtable('openChildTable',
                                      $img.closest('tr'),
                                      {
