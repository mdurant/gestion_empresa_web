...
$(".cant").keypress(function(event) {
    ...
    $("#Ingresars").on('click', function(event) {
        ...
        if ($("#contador").val() == "" || $("#folio").val() == "" || $("#proyecto").val() == "" || $("#motivo").val() == "" || $("#autoriza").val() == "" || $("#nombre_chofer").val() == "" || $("#placa_patente").val() == "") {
            alert("Rellene campos nescesarios del encabezado de la Guia de Despacho");
        } else {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                url: "insert_orden_sql.php",
                data: datasrl,
                success: function(response) {
                    //alert("O.T. creada correctamente!");
                    alert(response);
